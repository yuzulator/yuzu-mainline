...
wget -nc https://raw.githubusercontent.com/yuzulator/ext-linux-bin/main/appimage/deploy-linux.sh
wget -nc https://raw.githubusercontent.com/yuzulator/AppImageKit-checkrt/old/AppRun.sh
wget -nc https://github.com/yuzulator/ext-linux-bin/raw/main/appimage/exec-x86_64.so
# Set executable bit
chmod 755 \
    deploy-linux.sh \
    AppRun.sh \
